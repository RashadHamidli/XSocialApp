...
public class UserService {
    ...
    public UserResponse createUser(UserRequest userRequest) {
        User user = UserRequest.converteUserRequestToUser(userRequest);
    ...
    public UserResponse updateUserByUsername(String username, UserRequest userRequest) {
        User foundUser = userRepository.findByUsername(username).orElseThrow(() -> new IllegalArgumentException(STR."\{username} is not find"));
        User requestUser = UserRequest.converteUserRequestToUser(userRequest);
